...
class Character(object):
    ...
    def what_am_i(self):
        path, _, file_names = next(
            os.walk(os.path.join(os.getcwd(), "character_tracker", "archetypes"))
        )
        ...
        self.type = kind
        with open(os.path.join(path, f"{kind}.json"), "r") as f:
            string = f.read()
    ...
    def show_me_the_moves(self):
        ...
        valid_choices = [int(choice) for choice in list(self.info["moves"].keys())]
    ...
    def make_me_a_haven(self):
        ...
        valid_choices = [int(choice) for choice in list(self.info["haven"].keys())]
    ...
    def get_me_some_gear(self):
        ...
        valid_choices = [int(choice) for choice in list(self.info["gear"].keys())]
